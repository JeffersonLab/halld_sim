...
int main( int argc, char* argv[] ){
	...
	float Bslope= 2;   // exponential generated slope, must be small to accomodate empty target amplitudes with very low effective t slopes


	cout << " ProductionMechanism: Bslope=" << Bslope << " GeV-2" << endl;
