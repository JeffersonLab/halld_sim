...
int main( int argc, char* argv[] ){
  ...
  PlotGen plotGen( results );
    ...
    // Do NOT automatically attach histograms to the current directory.
    // This can cause unexpected overwriting.
    // Instead histograms are attached at end of following loop with 'plotfile->cd()' and 'thist->Write()'
