...
public:
  ...
  enum { kOmegaMass = 0, kCosThetaPi0, kCosThetaGamma, kPhiPi0, kPhiGamma, kCosTheta, kPhi, kphi, kPsi, kt, kThetaLabPi0, kThetaLabGamma, kPThetaLabPi0, kPThetaLabGamma, kNumHists};
