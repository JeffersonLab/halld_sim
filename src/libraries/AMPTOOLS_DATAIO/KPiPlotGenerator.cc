...
void TwoPiPlotGenerator::createHistograms() {
  ...
  bookHistogram( kPiPCosTheta, new Histogram1D( 36, -1., 1., "cosTheta", "cos( #theta ) of Resonance Production") );
  ...
  bookHistogram( kPhi, new Histogram1D( 36, -1*PI, PI, "Phi", "#Phi" ) );
  bookHistogram( kphi, new Histogram1D( 36, -1*PI, PI, "phi", "#phi" ) );
  bookHistogram( kPsi, new Histogram1D( 36, -1*PI, PI, "psi", "#psi" ) );
