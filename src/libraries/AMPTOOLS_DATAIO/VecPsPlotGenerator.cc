...
VecPsPlotGenerator::VecPsPlotGenerator(const FitResults &results, Option opt) : PlotGenerator(results, opt)
{
    createHistograms();
}

/* Constructor for event generator (no FitResult) */
VecPsPlotGenerator::VecPsPlotGenerator() : PlotGenerator()
{
    createHistograms();
}
...
void VecPsPlotGenerator::projectEvent(Kinematics *kin)
{
...
void VecPsPlotGenerator::projectEvent(Kinematics *kin, const string &reactionName)
{
