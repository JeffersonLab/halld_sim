...
public:
  ...
  enum { kOmegaPiMass = 0, kCosTheta = 1, kPhi = 2, kCosThetaH = 3, kPhiH = 4, kProd_Ang = 5, kt = 6, kRecoilMass = 7, kTwoPiMass = 8, kProtonPiMass = 9, kRecoilPiMass = 10, kLambda = 11, kDalitz = 12, kPhiDelta = 13, kCosThetaDelta = 14, kOmegaPiAngles = 15, kOmegaHAngles = 16, kDeltaAngles = 17, kBigLittlePhi = 18, kNumHists};
