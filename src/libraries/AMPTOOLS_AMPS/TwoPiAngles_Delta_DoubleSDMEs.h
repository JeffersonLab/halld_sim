#if !defined(TWOPIANGLES_DELTA_DOUBLESDMES)
...
class TwoPiAngles_Delta_DoubleSDMEs : public UserAmplitude< TwoPiAngles_Delta_DoubleSDMEs >
{
    
public:
	
	TwoPiAngles_Delta_DoubleSDMEs() : UserAmplitude< TwoPiAngles_Delta_DoubleSDMEs >() { };
	TwoPiAngles_Delta_DoubleSDMEs( const vector< string >& args );
	...
	string name() const { return "TwoPiAngles_Delta_DoubleSDMEs"; }
...
private:
  ...
  AmpParameter r00_33_1;
  AmpParameter r00_11_1;
  AmpParameter r11_33_1;
  AmpParameter r11_11_1;
  AmpParameter r1m1_33_1;
  AmpParameter r1m1_11_1;
  AmpParameter r10_33_1;
  AmpParameter r10_11_1;
  AmpParameter r00_31_1;
  AmpParameter r00_3m1_1;
  AmpParameter r11_31_1;
  AmpParameter r11_3m1_1;
  AmpParameter r1m1_31_1;
  AmpParameter r1m1_3m1_1;
  AmpParameter r10_31_1;
  AmpParameter r10_3m1_1;
  AmpParameter rt1m1_31_1;
  AmpParameter rt1m1_3m1_1;
  AmpParameter rt10_31_1;
  AmpParameter rt10_3m1_1;
  //alpha = 2 (different structure)
  AmpParameter rt00_31_2;
  AmpParameter rt00_3m1_2;
  AmpParameter rt11_31_2;
  AmpParameter rt11_3m1_2;
  AmpParameter r1m1_33_2;
  AmpParameter r1m1_11_2;
  AmpParameter r1m1_31_2;
  AmpParameter r1m1_3m1_2;
  AmpParameter rt1m1_31_2;
  AmpParameter rt1m1_3m1_2;
  AmpParameter r10_33_2;
  AmpParameter r10_11_2;
  AmpParameter r10_31_2;
  AmpParameter r10_3m1_2;
  AmpParameter rt10_31_2;
  AmpParameter rt10_3m1_2;
