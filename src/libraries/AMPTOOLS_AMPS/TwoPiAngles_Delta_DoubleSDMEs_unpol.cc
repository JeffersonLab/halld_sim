...
TwoPiAngles_Delta_DoubleSDMEs_unpol::TwoPiAngles_Delta_DoubleSDMEs_unpol( const vector< string >& args ) :
  UserAmplitude< TwoPiAngles_Delta_DoubleSDMEs_unpol >( args )
{
...
complex< GDouble >
TwoPiAngles_Delta_DoubleSDMEs_unpol::calcAmplitude( GDouble** pKin, GDouble* userVars ) const {
...
return complex< GDouble > ( sqrt(fabs(W0)) );
}

void
TwoPiAngles_Delta_DoubleSDMEs_unpol::calcUserVars( GDouble** pKin, GDouble* userVars ) const {
...
void
TwoPiAngles_Delta_DoubleSDMEs_unpol::launchGPUKernel( dim3 dimGrid, dim3 dimBlock, GPU_AMP_PROTO ) const {

  GPUTwoPiAngles_Delta_DoubleSDMEs_unpol_exec( dimGrid, dimBlock, GPU_AMP_ARGS,
    r00_33_0, //r00_11_0,
    r11_33_0, r11_11_0,
    r1m1_33_0, r1m1_11_0,
    r10_33_0, r10_11_0,
