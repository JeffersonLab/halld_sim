...
///////////////////////////////////////////////////////////////////////////////
__global__ void
GPUVec_ps_refl_kernel( GPU_AMP_PROTO, int m_j, int m_m, int m_l, int m_r, int m_s )
{
	...
	GDouble polFraction = GPU_UVARS(8);
	GDouble polAngle = GPU_UVARS(9);
...
{  
  	...
  	GPUVec_ps_refl_kernel<<< dimGrid, dimBlock >>>
    		( GPU_AMP_ARGS, m_j, m_m, m_l, m_r, m_s );
