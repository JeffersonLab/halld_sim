...
rho111  = AmpParameter( args[6] );

rho101  = AmpParameter( args[7] );
rho1m11 = AmpParameter( args[8] );
rho102  = AmpParameter( args[9] );
rho1m12 = AmpParameter( args[10] );

delta_rho011  = AmpParameter( args[11] );
delta_rho031  = AmpParameter( args[12] );
delta_rho03m1 = AmpParameter( args[13] );
rho001 = AmpParameter( args[14] );
// delta_rho111  = AmpParameter( args[14] );
// delta_rho133  = AmpParameter( args[15] );
// delta_rho131  = AmpParameter( args[16] );
// delta_rho13m1 = AmpParameter( args[17] );

// delta_rho231  = AmpParameter( args[18] );
// delta_rho23m1 = AmpParameter( args[19] );
...
GDouble cosTheta_piplus = userVars[kCosTheta_piplus];
GDouble sinSqTheta_piplus = userVars[kSinSqTheta_piplus];
GDouble sin2Theta_piplus = userVars[kSin2Theta_piplus];
GDouble phi_piplus = userVars[kPhi_piplus];
...
GDouble W0_baryon = 3.*(0.5 - delta_rho011)*sinSqTheta_piplus + delta_rho011*(1.+3.*cosTheta_piplus*cosTheta_piplus) - 2.*TMath::Sqrt(3.)*delta_rho031*cos(phi_piplus)*sin2Theta_piplus - 2.*TMath::Sqrt(3.)*delta_rho03m1*cos(2.*phi_piplus)*sinSqTheta_piplus;
// GDouble W1_baryon =  (3.*delta_rho133*sinSqTheta_piplus + delta_rho111*(1.+3.*cosTheta_piplus*cosTheta_piplus) - 2.*TMath::Sqrt(3.)*delta_rho131*cos(phi_piplus)*sin2Theta_piplus - 2.*TMath::Sqrt(3.)*delta_rho13m1*cos(2.*phi_piplus)*sinSqTheta_piplus);
// GDouble W2_baryon = (2.*TMath::Sqrt(3.)*delta_rho231*sin(phi_piplus)*sin2Theta_piplus + 2.*TMath::Sqrt(3.)*delta_rho23m1*sin(2.*phi_piplus)*sinSqTheta_piplus);
...
//boost in recoil frame
  ...
  TVector3 angles_proton_GJ_Delta( (piplus_resDelta.Vect()).Dot(x_GJ_Delta),
		   (proton_resDelta.Vect()).Dot(y),
  ...
  userVars[kCosTheta_piplus]   = angles_proton_hel_Delta.CosTheta();
  userVars[kSinSqTheta_piplus] = sin(angles_proton_hel_Delta.Theta())*sin(angles_proton_hel_Delta.Theta());
  userVars[kSin2Theta_piplus]  = sin(2.*angles_proton_hel_Delta.Theta());
  userVars[kPhi_piplus] = angles_proton_hel_Delta.Phi();
  }
  else{
  ...
  userVars[kCosTheta_piplus]   = angles_piplus_GJ_Delta.CosTheta();
  userVars[kSinSqTheta_piplus] = sin(angles_piplus_GJ_Delta.Theta())*sin(angles_piplus_GJ_Delta.Theta());
  userVars[kSin2Theta_piplus]  = sin(2.*angles_piplus_GJ_Delta.Theta());
  userVars[kPhi_piplus] = angles_piplus_GJ_Delta.Phi();
