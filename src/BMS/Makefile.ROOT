...
ROOT_MAJOR   := $(shell $(HALLD_SIM_HOME)/src/BMS/get_root_version MAJOR)
ROOT_MINOR   := $(shell $(HALLD_SIM_HOME)/src/BMS/get_root_version MINOR)
ROOT_SUBMINOR := $(shell $(HALLD_SIM_HOME)/src/BMS/get_root_version SUBMINOR)
